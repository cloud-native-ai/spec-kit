...
For detailed methodology, examples, anti-examples, and quality dimension patterns, see `.specify/shared/workflow/checklist-methodology.md`.
...
5. **Generate checklist** — Create "Unit Tests for Requirements":
   ...
   - Apply methodology from `.specify/shared/workflow/checklist-methodology.md`:
