...
1. **Analyze existing context**: 
   - Check if a `.specify.specify/memory/features.md` file already exists
...
3. **Create or update the feature index file**:
   - Generate a `.specify.specify/memory/features.md` file with proper header and feature entries in Markdown table format
...
The `.specify.specify/memory/features.md` file should follow this structure:
