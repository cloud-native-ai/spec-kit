---
name: layout-int-9d1f7d3e
description: |
  integration scenario
skill_id: "<SKILL:.specify/skills/layout-int-9d1f7d3e/SKILL.md>"
---
...
## Resource ID
- Canonical ID: `<SKILL:.specify/skills/layout-int-9d1f7d3e/SKILL.md>`
- Canonical Path: `.specify/skills/layout-int-9d1f7d3e/SKILL.md`
