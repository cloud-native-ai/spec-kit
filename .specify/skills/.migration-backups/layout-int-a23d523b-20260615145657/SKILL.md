---
name: layout-int-a23d523b
description: |
  integration scenario
skill_id: "<SKILL:.specify/skills/layout-int-a23d523b/SKILL.md>"
---
...
## Resource ID
- Canonical ID: `<SKILL:.specify/skills/layout-int-a23d523b/SKILL.md>`
- Canonical Path: `.specify/skills/layout-int-a23d523b/SKILL.md`
...
- Tool manifests (auto-generated). Refresh with:
  - `scripts/bash/create-new-skill.sh --refresh-only --name layout-int-a23d523b --json`
