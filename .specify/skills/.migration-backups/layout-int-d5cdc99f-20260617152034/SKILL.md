---
name: layout-int-d5cdc99f
description: |
  integration scenario
skill_id: "<SKILL:.specify/skills/layout-int-d5cdc99f/SKILL.md>"
---
...
## Resource ID
- Canonical ID: `<SKILL:.specify/skills/layout-int-d5cdc99f/SKILL.md>`
- Canonical Path: `.specify/skills/layout-int-d5cdc99f/SKILL.md`
