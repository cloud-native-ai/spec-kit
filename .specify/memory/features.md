...
| 031 | Glossary Mechanism | Single project-wide glossary (`.specify/memory/glossary.md`) anchoring project vocabulary and correcting voice/dictated input (homophones,易混淆词); initialized at instruction generation, ambient to all commands via the Documentation Map, progressively enriched at checkpoints with user-confirmed conflict handling and user-authoritative manual edits. | Planned | .specify/memory/features/031.md | .specify/specs/029-glossary-mechanism/requirements.md | 2026-07-16 |
