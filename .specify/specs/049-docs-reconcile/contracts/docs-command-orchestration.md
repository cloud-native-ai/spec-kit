...
**Requirement**: `049-docs-reconcile` → Feature 037 Docs Command
...
| C-8 | 规划时实测为 18 complex / 4 simple；合并上游 `derive` 后以分类 owner 的当前 **19 complex / 4 simple** 为准(`docs` 已在复杂集,本特性不改分类) |
