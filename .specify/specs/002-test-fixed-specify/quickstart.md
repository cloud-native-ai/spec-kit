...
This creates `.specify/memory/feature-index.md` with your first feature:
...
- Updates `.specify/memory/feature-index.md` status to "Planned" and records spec path
- Automatically stages the `.specify/memory/feature-index.md` change
...
- Updates `.specify/memory/feature-index.md` status to "Implemented"
- Automatically stages the `.specify/memory/feature-index.md` change
...
- Maintains "Implemented" status in `.specify/memory/feature-index.md`
- Automatically stages the `.specify/memory/feature-index.md` change
...
- Updates `.specify/memory/feature-index.md` status to "Ready for Review"
- Automatically stages the `.specify/memory/feature-index.md` change
...
If multiple team members update the same feature entry simultaneously, git will create a merge conflict in `.specify/memory/feature-index.md`. Resolve the conflict manually during the merge process - this is the expected behavior for concurrent updates.
...
Existing projects without `.specify/memory/feature-index.md` continue to work exactly as before. Feature tracking is only enabled when `.specify/memory/feature-index.md` exists in the project.