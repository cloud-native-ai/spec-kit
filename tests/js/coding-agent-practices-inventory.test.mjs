...
import { collectQoderInventory } from "../../scripts/js/better-harness/coding-agent-practices/inventory.mjs";
...
test("Qoder inventory CLI emits JSON and markdown without raw memory content", async () => {
  ...
  try {
    const script = path.join(process.cwd(), "scripts/js/better-harness/coding-agent-practices/inventory.mjs");
