...
} from "../../scripts/js/better-harness/session-analysis/platforms/qoder.mjs";
import { buildSessionEfficiencySignal } from "../../scripts/js/better-harness/session-analysis/session-efficiency.mjs";
import { buildUsageReviewPacket } from "../../scripts/js/better-harness/session-analysis/usage-review-packet.mjs";
import { calculateExactModelCost } from "../../scripts/js/better-harness/session-analysis/model-pricing.mjs";
import { detectPlanningSignals } from "../../scripts/js/better-harness/session-analysis/planning-signals.mjs";
import { privacySafeUserInputSummary } from "../../scripts/js/better-harness/session-analysis/privacy-safe-text.mjs";
import { isSessionAnalysisRef, sessionAnalysisRef } from "../../scripts/js/better-harness/session-analysis/session-ref.mjs";
...
test("Qoder and Codex UserPromptSubmit adapters extract prompt fields as user demand", async () => {
  ...
  const { CodexSessionAnalyzer } = await import("../../scripts/js/better-harness/session-analysis/platforms/codex.mjs");
...
test("Codex facts route exposes request, edit, and parsed lint counts without raw payloads", async () => {
  ...
  const { CodexSessionAnalyzer, main: codexMain } = await import("../../scripts/js/better-harness/session-analysis/platforms/codex.mjs");
  const analyzer = new CodexSessionAnalyzer();
  try {
    const result = await analyzer.analyze({
      home,
