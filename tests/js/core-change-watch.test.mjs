...
import { fileRoleFor } from "../../scripts/js/better-harness/core-change-watch/common.mjs";
import { analyzeChangeDrift } from "../../scripts/js/better-harness/core-change-watch/change-drift.mjs";
import { analyzeCoreCandidates } from "../../scripts/js/better-harness/core-change-watch/core-candidates.mjs";
import { analyzeDiffImpact } from "../../scripts/js/better-harness/core-change-watch/diff-impact.mjs";
import { buildEvidencePack } from "../../scripts/js/better-harness/core-change-watch/evidence-pack.mjs";
import { analyzeGitHistoryProfile } from "../../scripts/js/better-harness/core-change-watch/git-history-profile.mjs";
import { analyzeProjectProfile } from "../../scripts/js/better-harness/core-change-watch/project-profile.mjs";
import { parseAndNormalizeQoderOutput } from "../../scripts/js/better-harness/core-change-watch/qoder-consistency-schema.mjs";
...
test("project profile summarizes project identity, scale, and AGENTS instruction density", async () => {
  ...
  try {
    ...
    const cliResult = spawnSync(process.execPath, [
      path.join(process.cwd(), "scripts/js/better-harness/core-change-watch/project-profile.mjs"),
      "--cwd",
      repo,
      "--json",
...
test("core-change-watch scripts stay static and do not invoke qodercli", () => {
  ...
  const scriptDir = path.join(root, "scripts/js/better-harness/core-change-watch");
