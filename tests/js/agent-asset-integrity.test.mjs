...
import {
  ...
  titleSimilarity,
} from "../../scripts/js/better-harness/coding-agent-practices/asset-integrity.mjs";
...
test("public asset-integrity CLI stays read-only and omits Memory body text and private paths", async () => {
  ...
  try {
    ...
    const script = path.join(process.cwd(), "scripts", "js", "better-harness", "coding-agent-practices", "asset-integrity.mjs");
