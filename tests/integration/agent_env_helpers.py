"""Isolated-HOME bash invocation helpers for the agent-cli-setup unified env-var flow.

These helpers source ``skills/agent-cli-setup/scripts/config-agent.sh`` inside a
