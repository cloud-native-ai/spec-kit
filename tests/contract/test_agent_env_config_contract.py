...
Asserts that skills/agent-cli-setup/SKILL.md documents:
...
SKILL_MD = ROOT / "skills" / "agent-cli-setup" / "SKILL.md"
...
def skill_text() -> str:
    assert SKILL_MD.exists(), "skills/agent-cli-setup/SKILL.md does not exist"
