...
Process `$ARGUMENTS` per the [User Input Protocol](shared/workflow/user-input-protocol.md). Extract target Skill name (concise command-like identifier: letters, digits, hyphens, underscores).
