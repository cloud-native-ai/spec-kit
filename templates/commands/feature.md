...
Process `$ARGUMENTS` per the [User Input Protocol](shared/workflow/user-input-protocol.md). Interpret scope: empty → full-registry reconcile; concrete context (commit/PR/branch) → context mining; description → locate-and-converge.
