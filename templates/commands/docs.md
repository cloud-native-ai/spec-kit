...
- the **Reconcile Loop** R0–R6 per [shared/patterns/reconcile-pattern.md](shared/patterns/reconcile-pattern.md), with the four mandatory artifacts: 观察快照 (inline), 干跑计划 (`.specify/docs/plans/`), 审计日志 (`.specify/docs/audit/`, written even on 零收敛/无净变化), 残差报告 (inline);
